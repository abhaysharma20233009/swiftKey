...
const paragraphs = [
    "The sun rose over the horizon, casting a golden glow across the landscape/n. Birds chirped melodiously, welcoming the day. A gentle breeze rustled the leaves, creating a soothing symphony of nature. As the world awakened, the promise of new beginnings filled the air, inspiring hope and joy in every heart",
    "In the heart of the bustling city, a small café thrived amidst the chaos/n. Its warm ambiance and fragrant coffee drew people in. Patrons gathered, sharing stories and laughter, while the barista crafted artful lattes. This cozy haven offered a brief escape, a moment of connection in a fast-paced world",
    "The old library stood proudly, its shelves brimming with stories waiting to/n be discovered. Dust motes danced in the sunlight streaming through stained glass windows. Each book held a universe of adventure, wisdom, and imagination. Visitors wandered through the aisles, their hearts open to the magic of literature and knowledge",
    ...
    "Amidst the towering mountains, a hidden valley thrived with vibrant flora and fauna. Wildflowers painted the landscape in hues of purple, yellow, and red. The air was filled with the /n sweet scent of blooming petals. Nature's beauty flourished here, a testament to resilience and the delicate balance of life",
    ...
    "In a world increasingly dominated by technology, moments of genuine human connection became rare treasures. People longed for authenticity, seeking meaningful conversations over mere notifications. Small acts of kindness sparked joy, reminding everyone of the power of empathy and love. In this fast-paced life, hearts yearned for moments of simplicity"
];
