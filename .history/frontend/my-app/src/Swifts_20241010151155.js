    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
            ...
            <input
                ...
                placeholder={words[currentWordIndex]?.slice(inputValue.length) || ''}
            />
            <div style={{ fontSize: '24px', marginTop: '10px', textAlign: 'left', whiteSpace: 'pre-wrap' }}>
                {words.map((word, index) => (
                    <span
                        ...
                        style={{
                            ...
                            display: 'inline', // Change this to 'inline' to keep words together
                        }}
                    >
                        {word}
                    </span>
