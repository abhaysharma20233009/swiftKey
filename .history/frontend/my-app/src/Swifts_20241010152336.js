    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
            ...
            <div className="para" style={{
                ...
                maxWidth: '80%', // Limit width to 80% of the parent
                ...
                {words.map((word, index) => (
                    <span
                        ...
                        style={{
                            ...
                            display: 'inline-block', // Ensure each word is treated as a block element
                            width: 'calc(10% - 10px)', // Control width to fit approximately 10 words in a line
                        }}
                    >
                        {word}
                    </span>
